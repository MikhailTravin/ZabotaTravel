 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector(".read-also__slider")) new core(".read-also__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".images-products")) document.querySelectorAll(".images-product").forEach((product => {
            ...
            const thumbsSwiper = new core(thumbContainer, {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 6.5,
...
***************************************************************************** */
        ...
        containerElements.forEach((container => {
            ...
            function onFilterButtonClick(event) {
                ...
                const isProductsOthers = null !== container.closest(".products-others");
                ...
                if ("all" === filter) if (!isProductsOthers) {
                ...
                } else items.forEach((item => item.classList.remove(itemHiddenClass))); else items.forEach((item => {
            ...
            if (allCheckBox && otherCheckBoxes.length > 0) {
                ...
                otherCheckBoxes.forEach((item => {
                    item.addEventListener("click", (function() {
                        ...
                        if (!isAllChecked && checkedBoxes.length > 0) block.classList.add("_active"); else if (false === isAllChecked && 0 === checkedBoxes.length) block.classList.remove("_active");
                    }));
                }));
            }
        }));
