...
***************************************************************************** */
        ...
        const favourites = document.querySelectorAll(".item-products__favourites");
        if (favourites) favourites.forEach((favourite => {
            favourite.addEventListener("click", (function(e) {
                favourite.classList.toggle("_active");
            }));
        }));
        const productFavourites = document.querySelectorAll(".top-product__favorite");
        if (productFavourites) productFavourites.forEach((favourite => {
            favourite.addEventListener("click", (function(e) {
                favourite.classList.toggle("_active");
            }));
        }));
        ...
        if (filterSearchButtons) filterSearchButtons.forEach(((button, i) => {
            ...
            if (filterSearchArrow) filterSearchArrow.addEventListener("click", (function(e) {
                ...
                button.classList.toggle("_active", !elem_active);
                document.documentElement.classList.add("filter-search-open");
            }));
        }));
        ...
        if (checkboxContents) checkboxContents.forEach((content => {
            ...
            console.log(checkboxBlock.length);
        ...
        if (searchFilterButton) {
            searchFilterButton.addEventListener("click", (function(e) {
                document.documentElement.classList.toggle("filter-search-open");
            }));
            window.addEventListener("click", (e => {
                const target = e.target;
                if (!target.closest(".filters-search__content") && !target.closest(".title-mob") && !target.closest(".search__filter")) document.documentElement.classList.remove("filter-search-open");
            }));
            if (closes) closes.forEach((close => {
                close.addEventListener("click", (function(e) {
                    document.documentElement.classList.remove("filter-search-open");
                }));
            }));
        }
