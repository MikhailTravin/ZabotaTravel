...
***************************************************************************** */
        ...
        function sticky() {
            ...
            const popupTitleMob = document.querySelector(".slider-popup__titles-mob");
            ...
            if (popupTitleMob) {
                ...
                let hpopupTitleMob = window.getComputedStyle(popupTitleMob, false).height;
                hpopupTitleMob = Number(hpopupTitleMob.slice(0, hpopupTitleMob.length - 2));
                popupSlider.style.paddingTop = hpopupTitleMob + "px";
            }
            if (searchBottom) {
